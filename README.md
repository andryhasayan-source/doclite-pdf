...
**Десять инструментов для работы с PDF прямо в браузере.
Документы обрабатываются на вашем компьютере и никуда не загружаются.**
...
|---|---|
| <img src="screenshots/merge-ru.png" width="380"> | <img src="screenshots/split-ru.png" width="380"> |

| Сжатие | Водяной знак |
|---|---|
| <img src="screenshots/compress-ru.png" width="380"> | <img src="screenshots/watermark-ru.png" width="380"> |

| Подпись | Тарифы |
|---|---|
| <img src="screenshots/signature-ru.png" width="380"> | <img src="screenshots/pro-ru.png" width="380"> |
...
**Бесплатно** — три операции в сутки. Не «три инструмента из десяти», а любые
...
- В сеть уходит ровно один запрос: проверка ключа при активации платной версии.
...
- **PDF → Word и PDF → Excel работают с текстовыми PDF, а не со сканами.**
  Распознавания текста с изображений в расширении нет.
